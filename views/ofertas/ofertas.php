                    ...
                    <table class="usuarios-table">
                        ...
                        <thead>
                                ...
                                <th class="vista-escritorio">
                                    <div class="table-header-content">
                                        ...
                                        <button type="button" class="sort-button" data-column="2"
                                            title="Ordenar por fecha_oferta">
                                            ↕
                                        </button>
                                    </div>
                                </th>
                            ...
                            <tr class="usuarios-filter-row-table vista-escritorio">
                                ...
                                <th>
                                    <?php filtroMultiSelect('filtroUsuarioEscritorio', 0, 'Todas', $usuarioEmpresaFiltro); ?>
                                </th>

                                <th>
                                    <?php filtroMultiSelect('filtroIdEscritorio', 1, 'Todos', $IdFiltro); ?>
                                </th>

                                <th>
                                    <?php filtroMultiSelect('filtroFecha_ofertaEscritorio', 2, 'Todas', $Fecha_ofertaFiltro); ?>
                                </th>

                                <th>
                                    <?php filtroMultiSelect('filtroClienteEscritorio', 3, 'Todos', $ClienteEmpresaFiltro); ?>
                                </th>
